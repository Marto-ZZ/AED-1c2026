...
\end{enumerate}
Eh, loco, fatalista, distópico, relajá un toque... ¡va a salir todo bien!
\end{disclaimerbox}
...
\input{ejercicios-1/ej-1-1.tex}
\input{ejercicios-1/ej-2-1.tex}
\input{ejercicios-1/ej-3-1.tex}
\input{ejercicios-1/ej-4-1.tex}
\input{ejercicios-1/ej-5-1.tex}

\section*{1.2. Lógica trivaluada}

\input{ejercicios-1/ej-6-1.tex}
\input{ejercicios-1/ej-7-1.tex}

\section*{1.3. Lógica de primer orden}

\input{ejercicios-1/ej-8-1.tex}
\input{ejercicios-1/ej-9-1.tex}
\vspace{1cm}
\input{ejercicios-1/ej-10-1.tex}
\input{ejercicios-1/ej-11-1.tex}
\input{ejercicios-1/ej-12-1.tex}
